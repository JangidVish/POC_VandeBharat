      ...
      <div className="flex justify-between items-center w-full px-lg py-md max-w-full mx-auto">
        ...
        <div className="flex items-center gap-xl">
          <div className="flex items-center gap-md">
            <span
              className="font-h1 tracking-tighter text-primary cursor-pointer select-none"
            ...
            <div className="relative ml-md border-l border-outline-variant pl-md hidden sm:block">
              <button 
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-sm bg-surface-container-low border border-outline-variant hover:border-primary transition-all group"
              >
                <div className="flex flex-col items-start">
                  <span className="font-label-caps text-[8px] text-outline uppercase tracking-widest">Active Session</span>
                  <span className="font-body-sm text-[12px] font-bold text-primary truncate max-w-[140px]">
              ...
              {sessionOpen && (
                <>
                  ...
                  <div className="absolute top-full left-0 mt-1 w-[240px] bg-surface-container-lowest border border-outline-variant shadow-xl z-50 rounded-sm overflow-hidden animate-in fade-in slide-in-from-top-1">
          ...
          <nav className="hidden md:flex gap-lg items-center">
            {navItems.map((item) => (
              <a
                ...
                className={`pb-1 font-body-base transition-colors duration-200 cursor-pointer active:opacity-70 ${
                  isActive(item)
        ...
        <div className="flex items-center gap-md">
          ...
          <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-on-primary text-[12px] font-bold flex-shrink-0">
            VB
          </div>
